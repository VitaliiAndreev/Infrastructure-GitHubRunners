...
# from Common-Automation as a sibling checkout of this repo.
...
if (-not $_ic) {
    ...
    # (which has retry built in) ships inside Common.PowerShell, so it
...
# Common.PowerShell is available.
...
$src = [IO.Path]::Combine($PSScriptRoot, '..', '..')

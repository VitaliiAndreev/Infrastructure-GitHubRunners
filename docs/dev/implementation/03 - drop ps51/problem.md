...
Common-PowerShell (2.0.0), Infrastructure-Secrets (3.0.0),
...
|------|--------|---------|---------|
| `setup-secrets.ps1` | Common.PowerShell | `1.3.3` | `2.0.0` |
| `setup-secrets.ps1` | Infrastructure.Secrets | `2.1.0` | `3.0.0` |
| `register-runners.ps1` | Common.PowerShell | `1.3.3` | `2.0.0` |
| `register-runners.ps1` | Infrastructure.Secrets | `2.1.0` | `3.0.0` |
| `deregister-runners.ps1` | Common.PowerShell | `1.3.3` | `2.0.0` |
| `deregister-runners.ps1` | Infrastructure.Secrets | `2.1.0` | `3.0.0` |
| `Tests/Integration/Initialize-SshEnvironment.ps1` | Common.PowerShell | `1.3.3` | `2.0.0` |
...
| `README.md` | Prerequisites: `Common.PowerShell >= 1.3.3` → `>= 2.0.0` |
